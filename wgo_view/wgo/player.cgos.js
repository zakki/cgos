		...
		WGo.BasicPlayer.component.Control.menu.push({
			...
			args: {
				...
				click: function (player) {
					player._cgos =
						player._cgos ||
						new WGo.Player.Cgos(player, player.board);
...
(function () {
	...
	const update = function (e) {
		...
		this.winrate.blackScore.setAttribute(
			"points",
			this.blackScore.join(" ")
		);
		this.winrate.whiteWinrate.setAttribute("points", this.white.join(" "));
		this.winrate.whiteScore.setAttribute(
			"points",
			this.whiteScore.join(" ")
		);
	};
